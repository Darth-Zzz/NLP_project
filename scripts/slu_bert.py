...
from model.slu_bert_model import SLUBert
...
if args.testing:
    check_point = torch.load(open('checkpoints/bert_model.bin', 'rb'), map_location=device)
...
def predict():
    ...
    test_dataset = Example.load_dataset(test_path, is_train=False)
    predictions = {}
    with torch.no_grad():
...
if not args.testing:
    ...
    for i in range(args.max_epoch):
        ...
        if dev_acc > best_result['dev_acc']:
            ...
            }, open('checkpoints/bert_model.bin', 'wb'))
