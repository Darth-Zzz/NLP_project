...
from model.slu_bert_rnn_crf_model import SLUBertRNNCRF
...
train_dataset = Example.load_dataset(train_path, is_train=True)
dev_dataset = Example.load_dataset(dev_path, is_train=False)
...
if args.testing:
    check_point = torch.load(open('bert_model.bin', 'rb'), map_location=device)
...
if not args.testing:
    ...
    for i in range(args.max_epoch):
        ...
        if dev_acc > best_result['dev_acc']:
            ...
            }, open('checkpoints/bert_rnn_crf_model.bin', 'wb'))
