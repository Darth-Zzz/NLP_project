...
class SLUBert(nn.Module):
    ...
    def __init__(self, config):
        ...
        # self.tokenizer = BertTokenizer.from_pretrained("hfl/chinese-bert-wwm-ext", cache_dir='./pretrained')
        self.tokenizer = BertTokenizer.from_pretrained("bert-base-chinese", cache_dir='./pretrained')
        # self.bert = BertModel.from_pretrained("hfl/chinese-bert-wwm-ext", cache_dir='./pretrained')
    ...
    def bert_encode(self, batch):
        # utt = [' '.join(sentence.replace(' ', '-')) for sentence in batch.utt] 
        utt = batch.utt
